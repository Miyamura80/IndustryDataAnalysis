...
def _(mo):
    ...
    **How to read the icicle:**
    - Root uses the ~US\$5.5T ex-pharma estimate; itemized segments are shown and the remainder is many smaller/formulated lines; children roll up with branchvalues="total".
